...
> ⏱️ pybenchx is a pragmatic microbenchmark tool: fast iteration (smoke profile), precise hot-path timing (context mode), and clear reports you can export and compare.
